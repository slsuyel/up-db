...
const UnionReports = () => {
  ...
  const handleSubmit = (event: { preventDefault: () => void }) => {
    ...
    const url = `https://api.uniontax.gov.bd/payment/report/download?union=${smallUnion}&from=${formData?.fromDate}&to=${formData?.toDate}&sonod_type=${formData?.sonod}&token=${token}`;
